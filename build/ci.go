...
import (
	...
	"github.com/FinanceFutureFactory/3fcoin/core/crypto/signify"
	"github.com/FinanceFutureFactory/3fcoin/core/lib/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/FinanceFutureFactory/3fcoin/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/FinanceFutureFactory/3fcoin/mobile")
