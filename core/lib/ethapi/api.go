...
import (
	...
	"github.com/FinanceFutureFactory/3fcoin/core/accounts/scwallet"
	...
	"github.com/FinanceFutureFactory/3fcoin/core/common/math"
...
//
// https://github.com/FinanceFutureFactory/3fcoin/core/wiki/Management-APIs#personal_sign
...
//
// https://github.com/FinanceFutureFactory/3fcoin/core/wiki/Management-APIs#personal_ecRecover
...
func SubmitTransaction(ctx context.Context, b Backend, tx *types.Transaction) (common.Hash, error) {
	...
	if tx.To() == nil {
		...
		log.Info("Submitted contract creation", "hash", tx.Hash().Hex(), "from", from, "nonce", tx.Nonce(), "contract", addr, "value", tx.Value())
	} else {
