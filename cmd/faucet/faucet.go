...
import (
	...
	"github.com/FinanceFutureFactory/3fcoin/cmd/utils"
...
var (
	...
	bep2eSymbols       = flag.String("bep2eSymbols", "", "the symbol of bep2p token")
	bep2eAmounts       = flag.String("bep2eAmounts", "", "the amount of bep2p token")
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/FinanceFutureFactory/3fcoin/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
