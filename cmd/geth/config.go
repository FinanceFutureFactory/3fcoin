...
import (
	...
	global_config "github.com/FinanceFutureFactory/3fcoin/config"
	"github.com/FinanceFutureFactory/3fcoin/core/common"
	"github.com/FinanceFutureFactory/3fcoin/core/core"
	"github.com/FinanceFutureFactory/3fcoin/core/eth/catalyst"
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = global_config.IPCPath
	return cfg
}
func GetDefaultGenesis() *core.Genesis {
...
func makeConfigNode(ctx *cli.Context) (*node.Node, gethConfig) {
	...
	if defaultGenesis != nil {
		cfg.Eth.Genesis = defaultGenesis
	}
	cfg.Eth.NetworkId = global_config.NetworkID
	// Load config file.
	...
	global_config.IPCPath = cfg.Node.IPCEndpoint()
